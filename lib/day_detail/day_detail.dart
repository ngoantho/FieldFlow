        ...
        ...dayModel.locationList.map((location) {
          return Row(
            children: [
              Expanded(
                  child: Text(
                      '           You spent ${location.duration.inHours} hours, ${location.duration.inMinutes} minutes, ${location.duration.inSeconds} seconds at Location: ${location.latitude} - ${location.longitude}\n\n\n',
