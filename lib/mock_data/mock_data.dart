...
final mockWeekList = [
  WeekModel([
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 19, hours: 8)),
    ...
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 18, hours: 9)),
    ...
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 17, hours: 7)),
    ...
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 16, hours: 10)),
    ...
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 15, hours: 6)),
  ...
  WeekModel([
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 12, hours: 8)),
    ...
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 11, hours: 8)),
    ...
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 10, hours: 8)),
    ...
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 9, hours: 8)),
    ...
    DayModel(
        CheckEntryModel(DateTime.now().subtract(Duration(days: 8, hours: 8)),
